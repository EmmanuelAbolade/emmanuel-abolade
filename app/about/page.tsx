        ...
        <div className="container">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "800px" }}>
            {EXPERIENCE.map((item) => {
              ...
              return (
                <div key={item.role} className="card" style={{ display: "flex", gap: "1.25rem" }}>
                  <div style={{
                    ...
                    <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "0.4rem" }}>
                      {item.points.map((point, i) => (
                        <li key={i} style={{
                          ...
                          lineHeight: 1.65, paddingLeft: "1rem", position: "relative",
                        }}>
                          <span style={{
        ...
        <div className="container">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "800px" }}>
            {EDUCATION.map((item) => {
              const Icon = item.icon
              return (
                <div key={item.degree} className="card" style={{ display: "flex", gap: "1.25rem" }}>
                  <div style={{
                    width: "2.5rem", height: "2.5rem", minWidth: "2.5rem",
                    background: "var(--accent-subtle)", borderRadius: "0.5rem",
                    display: "flex", alignItems: "center", justifyContent: "center",
      ...
      <section className="section" style={{ background: "var(--bg)" }}>
        <div className="container">
          ...
          <div style={{
            ...
            gap: "1.5rem", maxWidth: "900px",
          }}>
            {[
              {
                title: "Content Creation",
                description: "Creator of StayEnriched and TreasuredStoriesForKids — YouTube channels built around storytelling, education, and community engagement.",
                icon: Video,
              },
              {
                title: "Event Videography",
                description: "Capturing, editing, and presenting stories at events in a way that resonates with audiences — sharpening visual thinking and detail orientation.",
                icon: Video,
              },
              {
                title: "Charity Work",
                description: "Actively involved in volunteering and community service, believing that giving back is part of what it means to build something meaningful.",
                icon: Briefcase,
              },
            ].map((item) => {
              const Icon = item.icon
              return (
                <div key={item.title} className="card">
                  ...
                  <h3 style={{
                    fontFamily: "DM Serif Display, serif",
                    fontSize: "1.1rem", color: "var(--text-primary)", marginBottom: "0.75rem",
                  }}>
                    {item.title}
                  </h3>
...
// Extracted text side — reused in both desktop and mobile layouts
function AboutText() {
  return (
    <div>
      <p style={{
      ...
      <h1 style={{
        ...
        lineHeight: 1.15, color: "var(--text-primary)", marginBottom: "1.5rem",
      }}>
        Developer, creator,
        <br />
        and problem solver.
...
// Extracted photo side — used in desktop layout
function AboutPhoto() {
  return (
